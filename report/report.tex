...
% you would do differently if you were to do the lab again.}
  ...
  To debug our symbol table, we wrote a \simplecode{dump} method for the symbol table that extracts key information from the symbol table, 
  and prints out a ascii table. In order to do so, we imported a open-source package named \simplecode{asciitable}, and wrote a adapter class 
  \simplecode{TablePrinter} to keep all dependencies to the package within the adapter.
